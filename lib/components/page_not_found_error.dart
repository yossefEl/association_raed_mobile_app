...
class NotFoundErrorPage extends StatelessWidget {
  ...
  const NotFoundErrorPage({Key key, this.onPressed}) : super(key: key);
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Image.asset("assets/images/error_icons/page_not_found.png",height: 150,),
            ),
            Container(
              ...
              child: Text("Ooops!!\n This page is not available for this moment!.",textAlign: TextAlign.center,)),
            Center(
              child: PrimaryButton(
                onPressed: onPressed,
